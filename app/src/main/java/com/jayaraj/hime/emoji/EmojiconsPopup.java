...
public class EmojiconsPopup extends PopupWindow
   ...
   * Constructor
   *
   * @param rootView The top most layout in your view hierarchy. The difference of this view and the
   *     screen height will be used to calculate the keyboard height.
  ...
  /**
   * Use this function to show the emoji popup. NOTE: Since, the soft keyboard sizes are variable on
   * different android devices, the library needs you to open the soft keyboard atleast once before
   * calling this function. If that is not possible see showAtBottomPending() function.
   */
  public void showAtBottom() {
    showAtLocation(rootView, Gravity.BOTTOM, 0, 0);
  }
  /**
   * Use this function when the soft keyboard has not been opened yet. This will show the emoji
   * popup after the keyboard is up next time. Generally, you will be calling
   * InputMethodManager.showSoftInput function after calling this function.
   */
   ...
   * clickListener, emulating keyboard-like behaviour. First click is fired immediately, next before
   * initialInterval, and subsequent before normalInterval.
   *
   * <p>
   *
   * <p>Interval is scheduled before the onClick completes, so it has to run fast. If it runs slow,
   * it does not generate skipped onClicks.
   */
