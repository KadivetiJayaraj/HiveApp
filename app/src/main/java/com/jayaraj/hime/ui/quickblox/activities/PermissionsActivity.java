...
public class PermissionsActivity extends AppCompatActivity {
  ...
  public static void startActivity(
      Activity activity, boolean checkOnlyAudio, String... permissions) {
      ...
      for (int i = 0; i < grantResults.length; i++) {
        if (grantResults[i] != 0) {
          ToastUtils.longToast(
              getString(R.string.permission_unavailable, permissionFeatures.values()[i]));
        }
      }
    } else {
      ToastUtils.longToast(
          getString(R.string.permission_unavailable, permissionFeatures.MICROPHONE));
    }
  }
