...
public class QBResRequestExecutor {
  ...
  public void loadLastUpdatedUsers(
      QBPagedRequestBuilder qbPagedRequestBuilder,
      final QBEntityCallback<ArrayList<QBUser>> callback) {
    QBUsers.getUsers(qbPagedRequestBuilder).performAsync(callback);
  }

  public void loadUsersByIds(
      final Collection<Integer> usersIDs, final QBEntityCallback<ArrayList<QBUser>> callback) {
