package com.jayaraj.hime.ui.quickblox.adapters;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
  ...
  public void setSelectedItemsCountsChangedListener(
      SelectedItemsCountChangedListener selectedItemsCountChanged) {
  ...
  public void onBindViewHolder(@NonNull UsersAdapter.ViewHolder holder, int position) {
    ...
    if (selectedUsers.contains(user)) {
      ...
      holder.opponentIcon.setBackgroundDrawable(
          UiUtils.getColoredCircleDrawable(
              context.getResources().getColor(R.color.icon_background_color_selected_user)));
