...
public class ErrorUtils {
  ...
  private static final String NO_CONNECTION_ERROR =
      App.getInstance().getString(R.string.no_connection_error);
  private static final String NO_RESPONSE_TIMEOUT =
      App.getInstance().getString(R.string.no_responce_timeout);
  ...
  private static Snackbar showSnackbar(
      View view, String message, @StringRes int actionLabel, View.OnClickListener clickListener) {
  ...
  public static void showErrorToast(QBResponseException exception) {
    ToastUtils.shortToast(
        String.format(
            "[ERROR] Request has been completed with errors: %s",
            exception.getErrors() + ", code: " + exception.getHttpStatusCode()));
  }
  ...
  public static void showErrorDialog(
      Context context, @StringRes int errorMessage, List<String> errors) {
