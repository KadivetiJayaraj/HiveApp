...
import com.jayaraj.hime.ui.quickblox.fragments.SettingsFragment;
import com.jayaraj.hime.ui.quickblox.utils.ToastUtils;
import com.jayaraj.hime.ui.quickblox.view.SeekBarPreference;
...
public class SettingsActivity extends BaseActivity
  ...
  private void setDefaultstartingBitrate(SharedPreferences sharedPreferences) {
    ...
    editor.putInt(
        bitrateStringKey, Integer.parseInt(getString(R.string.pref_startbitratevalue_default)));
    editor.apply();
