...
import com.jayaraj.hime.ui.quickblox.util.ChatPingAlarmManager;
...
public class LoginService extends Service {
    ...
    chatService.login(
        ...
        new QBEntityCallback<QBUser>() {
          ...
          public void onError(QBResponseException e) {
            ...
            sendResultToActivity(false, e.getMessage() != null ? e.getMessage() : "Login error");
          }
        });
  }
  ...
  private void initPingListener() {
    ...
    ChatPingAlarmManager.getInstanceFor()
        .addPingListener(
  ...
  private void sendResultToActivity(boolean isSuccess, String errorMessage) {
    if (pendingIntent != null) {
      ...
      try {
        ...
        Log.d(
            TAG,
            errorMessageSendingResult != null
