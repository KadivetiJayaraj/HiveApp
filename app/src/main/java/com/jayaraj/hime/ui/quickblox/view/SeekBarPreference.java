package com.jayaraj.hime.ui.quickblox.view;
...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
  ...
  private void initFields(Context context, AttributeSet attrs) {
    ...
    int stepSizeValueResourceId =
        attrs.getAttributeResourceValue(SEEKBAR_NS, "stepSize", R.integer.pref_default_int_value);
