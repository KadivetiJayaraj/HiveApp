...
import com.jayaraj.hime.ui.quickblox.utils.QBRTCSessionUtils;
...
public class OpponentsFromCallAdapter
  ...
  public OpponentsFromCallAdapter(
      Context context,
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    v.findViewById(R.id.innerLayout)
        .setLayoutParams(new FrameLayout.LayoutParams(itemWidth, itemHeight));
