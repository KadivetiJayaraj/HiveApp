package com.jayaraj.hime.ui.quickblox.util;
...
public class ChatPingAlarmManager {
  ...
  /**
   * Register a pending intent with the AlarmManager to be broadcasted every half hour and register
   * the alarm broadcast receiver to receive this intent. The receiver will check all known
   * questions if a ping is Necessary when invoked by the alarm intent.
   *
   * @param context
   */
