...
public class ImageUtils {
  ...
  /**
   * Đối với ảnh hình chữ nhật thì cần cắt ảnh theo hình vuông và lấy phần tâm ảnh để khi đặt làm
   * avatar sẽ không bị méo
   *
   * @param srcBmp
   * @return
   */
   ...
   * @return
   */
  public static Bitmap makeImageLite(
      InputStream is, int width, int height, int reqWidth, int reqHeight) {
    int inSampleSize = 1;
